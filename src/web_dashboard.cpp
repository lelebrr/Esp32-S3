 ...
 * @brief Web Dashboard HTTP Server
 *
 * Provides a hidden WiFi AP with HTTP API for controlling attacks.
 * Uses ESPAsyncWebServer with Basic Authentication.
 *
