...
void showDeviceInfo() {
    ...
    area.addLine("Lele Version: " + String(LELE_VERSION));
    ...
    area.addLine("Brightness: " + String(leleConfig.bright) + "%");
    area.addLine("");
#endif

    area.addLine("[GPIO]");
    area.addLine("GROVE_SDA: " + String(leleConfigPins.i2c_bus.sda));
    area.addLine("GROVE_SCL: " + String(leleConfigPins.i2c_bus.scl));
    area.addLine("SERIAL TX: " + String(leleConfigPins.uart_bus.tx));
    area.addLine("SERIAL RX: " + String(leleConfigPins.uart_bus.rx));
