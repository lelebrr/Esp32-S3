...
bool EthernetHelper::setup() {
    ...
    spi_bus_config_t buscfg = {
        .mosi_io_num = leleConfigPins.W5500_bus.mosi,
        .miso_io_num = leleConfigPins.W5500_bus.miso,
        .sclk_io_num = leleConfigPins.W5500_bus.sck,
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
    ...
    spi_eth_module_config.spi_cs_gpio = leleConfigPins.W5500_bus.cs;
    spi_eth_module_config.int_gpio = leleConfigPins.W5500_bus.io0;
