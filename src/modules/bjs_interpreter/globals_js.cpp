...
duk_ret_t registerGlobals(duk_context *ctx) {
    ...
    bduk_register_string(ctx, "LELE_VERSION", LELE_VERSION);
    bduk_register_int(ctx, "Lele_PRICOLOR", leleConfig.priColor);
    bduk_register_int(ctx, "Lele_SECCOLOR", leleConfig.secColor);
    bduk_register_int(ctx, "Lele_BGCOLOR", leleConfig.bgColor);
    return 0;
}
