...
duk_ret_t native_pins(duk_context *ctx) {
    ...
    bduk_put_prop(ctx, obj_idx, "grove_sda", duk_push_uint, leleConfigPins.i2c_bus.sda);
    bduk_put_prop(ctx, obj_idx, "grove_scl", duk_push_uint, leleConfigPins.i2c_bus.scl);
    bduk_put_prop(ctx, obj_idx, "serial_tx", duk_push_uint, leleConfigPins.uart_bus.tx);
    bduk_put_prop(ctx, obj_idx, "serial_rx", duk_push_uint, leleConfigPins.uart_bus.rx);
