...
void Pn532ble::loadNdefEmulateMenu() {
    ...
    options = {
        {"Visit Lele", [&]() { prefix = "https://Lele.computer"; }},
...
void Pn532ble::hf14aScan() {
    ...
    if (tagInfo.uid.empty()) {
        ...
        if (tagInfo.sak == 0x00) {
            ...
            padprintln("Gen1A: " + String(isGen1A ? "Sim" : "N�o"));
            bool isGen3 = pn532_ble.isGen3();
            padprintln("Gen3:  " + String(isGen3 ? "Sim" : "N�o"));
            bool isGen4 = pn532_ble.isGen4(gen4pwd);
            padprintln("Gen4:  " + String(isGen4 ? "Sim" : "N�o"));
        }
    }
}
...
void Pn532ble::loadMifareClassicDumpFile() {
    ...
    String filePath = loopSD(*fs, true, "bin", "/LeleRFID");
    if (filePath == "") {
