    ...
    if (nrf_start(mode)) {
        ...
        while (!check(SelPress)) {
            ...
            if (redraw) {
                ...
                tft.fillRect(10, 100, tftWidth - 20, FM * LH, leleConfig.bgColor);
    ...
    if (nrf_start(mode)) {
        ...
        while (!check(SelPress)) {
            ...
            if (redraw) {
                ...
                tft.fillRect(10, 116, tftWidth - 20, FM * LH, leleConfig.bgColor);
...
void nrf_channel_hopper() {
    ...
    while (hopmenu) {
        ...
        if (redraw) {
            ...
            tft.drawRect(5, yHighlight - 2, tftWidth - 10, 18, leleConfig.priColor);
            if (CHECK_NRF_UART(mode) || CHECK_NRF_BOTH(mode)) {
