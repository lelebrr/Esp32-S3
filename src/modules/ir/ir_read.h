...
class IrRead {
public:
    // IRrecv irrecv = IRrecv(leleConfig.irRx);
    IRrecv irrecv = IRrecv(leleConfig.irRx, SAFE_STACK_BUFFER_SIZE / 2, 50);
...
private:
    ...
    std::vector<String> quickButtonsTV = {"POWER", "UP",   "DOWN", "LEFT",  "RIGHT", "OK",       "SOURCES",
                                          "VOL+",  "VOL-", "CHA+", "CHA-",  "MUTE",  "Configura��es", "NETFLIX",
    ...
    std::vector<String> quickButtonsSOUND = {"POWER",    "UP",      "DOWN", "LEFT",    "RIGHT",
                                             ...
                                             "Configura��es", "BACK",    "EQ",   "REC",     "PLAY/PAUSE",
