...
void WardrivingLogger::logWiFi(String ssid, String bssid, int32_t rssi, int32_t channel, String encrypt) {
    ...
    line += String(GPSDriver::getLatitude(), 6) + "," + String(GPSDriver::getLongitude(), 6) + "," +
            String(GPSDriver::getAltitude(), 1) + ",";
...
uint32_t WardrivingLogger::getLogCount() { return _logCount; }
